...
from sknetwork.data.parse import parse_edge_list, load_labels, load_header, load_metadata
...
def load_konect(dataset: str, data_home: Optional[Union[str, Path]] = None, auto_numpy_bundle: bool = True) -> Bunch:
    ...
    if matrix:
        ...
        if bipartite:
            graph = parse_edge_list(data_path / file, directed=directed, bipartite=bipartite, weighted=weighted)
