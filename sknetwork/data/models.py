...
class SBM(BiGraph):
    ...
    """
    def __init__(self, clusters: Union[np.ndarray, int], shape: Optional[Tuple[int, int]] = None,
        ...
        self.biadjacency = sparse.csr_matrix(mat)
        self.labels = ground_truth_samples
        self.labels_row = ground_truth_samples
        self.labels_col = ground_truth_features
