...
def check_n_neighbors(n_neighbors: int, n_seeds: int):
    """Set the number of neighbors so that it is less than the number of samples."""
    if n_neighbors >= n_seeds:
        warnings.warn(Warning("The number of neighbors must be lower than the number of nodes. "
                              "Changed accordingly."))
